                                          ...
                                          @if($brands->count() > 0)
                                            ...
                                            <tr>
                                              ...
                                              <td class="d-flex">
                                                ...
                                                <a href="{{ route('brand.edit',$brand->id) }}" class="btn  btn-outline-primary btn-sm   mr-1"> <i class="fas fa-edit"></i> </a>
                                                <a href="{{ route('brand.show',$brand->id) }}" class="btn  btn-outline-warning btn-sm mr-1"> <i class="fas fa-eye"></i> </a>

                                                <a href="javascript:void(0)" data-form_id="brand_delete_{{ $brand->id }}" class="btn  btn-outline-danger btn-sm  mr-1 brand_delete ">
                                                   <i class="fas fa-trash"></i> 
                                                </a>
                                                <form id="brand_delete_{{ $brand->id }}" action="{{ route('brand.destroy',$brand->id) }}" method="POST" >
                                                  @csrf
                                                  @method('delete')
                                                </form>
