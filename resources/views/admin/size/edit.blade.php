                            ...
                            <div class="card card-primary card-outline">
                                <div class="row">
                                    <div class="col-12 col-lg-6 col-md-8 offset-lg-3 offset-md-2">
                                        <!-- form start -->
                                        <form role="form" action="{{ route('size.update',$size->id) }}" id="update_size" method="post">
                                            @csrf
                                            @method('put')
                                            <div class="row mt-5 ml-2 mr-2">
                                                <div class="col-md-8 offset-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="name" name="name" value="{{ $size->name }}" class="form-control" id="name" placeholder="Enter size name" >
                                                        @if ($errors->has('name'))
