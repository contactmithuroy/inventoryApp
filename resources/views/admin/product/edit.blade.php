                            ...
                            <div class="card card-primary card-outline">
                                <div class="row">
                                    <div class="col-12 col-lg-6 col-md-8 offset-lg-3 offset-md-2">
                                        <!-- form start -->
                                        <form role="form" action="{{ route('brand.update',$brand->id) }}" id="update_brand" method="post">
                                            @csrf
                                            @method('put')
                                            <div class="row mt-5 ml-2 mr-2">
                                                <div class="col-md-8 offset-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="name" name="name" value="{{ $brand->name }}" class="form-control" id="name" placeholder="Enter brand name" >
                                                        @if ($errors->has('name'))
